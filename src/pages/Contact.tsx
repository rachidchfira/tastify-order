      ...
      <div className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            <div className="lg:col-span-2">
              <div className="bg-white rounded-lg shadow-md p-6">
                <h2 className="text-2xl font-bold mb-6 text-brand-red">Send Us a Message</h2>
            ...
            <div>
              <div className="bg-brand-cream rounded-lg shadow-md p-6 mb-6">
                <h2 className="text-2xl font-bold mb-6 text-brand-red">Contact Information</h2>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        +84 123 456 789<br />
                        +84 987 654 321 (Reservations)
                      </p>
                    </div>
                  </div>
                  
                  <div className="flex items-start">
                    <Mail className="h-6 w-6 text-brand-red mt-1 mr-3 shrink-0" />
                    <div>
                      <h4 className="font-semibold text-lg mb-1">Email</h4>
                      <p className="text-gray-700">
                        info@tastybowl.com<br />
                        reservations@tastybowl.com
                      </p>
                    </div>
                  </div>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <h2 className="text-2xl font-bold p-6 text-brand-red">Find Us</h2>
            <div className="h-96">
              <iframe 
